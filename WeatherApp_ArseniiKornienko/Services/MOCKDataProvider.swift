    ...
    static var data: [MOCKData] {
        return [
            ...
            MOCKData(titleData: TitleData(title: Constants.title.currentText,
                     ...
                     description: Constants.dayDescription.currentText,
                     dayTempData: ([DayTempData(icon: sunIcon,
                                                temp: 25,
                                                time: "Сейчас"),
            ...
            MOCKData(titleData: TitleData(title: Constants.title.secondText,
                     ...
                     description: Constants.dayDescription.secondText,
                     dayTempData: ([DayTempData(icon: cloudMoonIcon,
                                                temp: 13,
                                                time: "Сейчас"),
            ...
            MOCKData(titleData: TitleData(title: Constants.title.thirdText,
                                          ...
                                          backgroundImage: sunSkyImage),
                     description: Constants.dayDescription.thirdText,
                     dayTempData: ([DayTempData(icon: sunIcon,
                                                temp: 28,
                                                time: "Сейчас"),
                                    DayTempData(icon: sunIcon,
            ...
            MOCKData(titleData: TitleData(title: Constants.title.fourthText,
                     ...
                     description: Constants.dayDescription.fourthText,
                     dayTempData: ([DayTempData(icon: cloudSunIcon,
                                                temp: 24,
                                                time: "Сейчас"),
            ...
            MOCKData(titleData: TitleData(title: Constants.title.fifthText,
                     ...
                     description: Constants.dayDescription.fifthText,
                     dayTempData: ([DayTempData(icon: moonIcon,
                                                temp: 13,
                                                time: "Сейчас"),
                                    DayTempData(icon: moonIcon,
                                                temp: 13,
            ...
            MOCKData(titleData: TitleData(title: Constants.title.sixthText,
                                          ...
                                          backgroundImage: cloudNightImage),
                     description: Constants.dayDescription.sixthText,
                     dayTempData: ([DayTempData(icon: cloudMoonIcon,
                                                temp: 18,
                                                time: "Сейчас"),
                                    DayTempData(icon: cloudMoonIcon,
            ...
            MOCKData(titleData: TitleData(title: Constants.title.seventhText,
                     ...
                     description: Constants.dayDescription.seventhText,
                     dayTempData: ([DayTempData(icon: windIcon,
                                                temp: 22,
                                                time: "Сейчас"),
            ...
            MOCKData(titleData: TitleData(title: Constants.title.eigthText,
                                          ...
                                          backgroundImage: cloudNightImage),
                     description: Constants.dayDescription.eigthText,
                     dayTempData: ([DayTempData(icon: cloudMoonIcon,
                                                temp: 19,
                                                time: "Сейчас"),
                                    DayTempData(icon: cloudIcon,
            ...
            MOCKData(titleData: TitleData(title: Constants.title.ninthText,
                                          ...
                                          backgroundImage: sunSkyImage),
                     description: Constants.dayDescription.ninthText,
                     dayTempData: ([DayTempData(icon: sunIcon,
                                                temp: 33,
                                                time: "Сейчас"),
                                    DayTempData(icon: sunIcon,
